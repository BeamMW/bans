...
var _outputCssLoader = require("./outputCssLoader");
...
function webpack4Loader(content, inputSourceMap) {
  ...
  if (((_webpackResolveOption = webpackResolveOptions.extensions) === null || _webpackResolveOption === void 0 ? void 0 : _webpackResolveOption.length) === 0) {
  ...
  if (result.cssText) {
    ...
    (0, _outputCssLoader.addFile)(this.resourcePath, cssText);
