...
export const Notification = ({ notification, text, handler, closeHandler = null, passKey }) => {
  ...
  return (
    <SplitContainer passKey={passKey} styles={{ background: "rgb(9 19 30)", /* position: "absolute", */ width: "100%", maxWidth: "650px"/* , marginTop: 10 * passKey */ }} leftWeight={5} rightWeight={7} height="59px" key={passKey}>
