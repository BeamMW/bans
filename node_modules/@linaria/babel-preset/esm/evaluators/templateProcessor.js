...
import unwrapNode from '../utils/unwrapNode'; // Match any valid CSS units followed by a separator such as ;, newline etc.
...
export default function getTemplateProcessor(options) {
  return function process({
    ...
    const [rules, classes] = tagProcessor.extractRules(valueCache, cssText, path.parent?.loc);
