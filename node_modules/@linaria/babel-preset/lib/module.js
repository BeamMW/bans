  ...
  evaluate(text, only = null) {
    ...
    if (action === 'ignore') {
      ...
      const evaluator = typeof action === 'function' ? action : require(require.resolve(action, {
        paths: [(0, _path.dirname)(this.filename)]
      })).default; // For JavaScript files, we need to transpile it and to get the exports of the module
