...
declare type HandlerFn = <TParent extends Node = Node>(builder: GraphBuilderState, node: Identifier, parent: TParent, parentKey: VisitorKeys<TParent>, listIdx: number | null) => void;
